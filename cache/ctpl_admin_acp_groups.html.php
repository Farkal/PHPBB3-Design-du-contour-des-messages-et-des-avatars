...
<?php if ($this->_rootref['S_EDIT']) {  ?>
	...
	<fieldset>
		<legend><?php echo ((isset($this->_rootref['L_GROUP_CONTOUR_AVATAR'])) ? $this->_rootref['L_GROUP_CONTOUR_AVATAR'] : ((isset($user->lang['GROUP_CONTOUR_AVATAR'])) ? $user->lang['GROUP_CONTOUR_AVATAR'] : '{ GROUP_CONTOUR_AVATAR }')); ?></legend>
	<dl>
		<dt><label><?php echo ((isset($this->_rootref['L_CURRENT_IMAGE'])) ? $this->_rootref['L_CURRENT_IMAGE'] : ((isset($user->lang['CURRENT_IMAGE'])) ? $user->lang['CURRENT_IMAGE'] : '{ CURRENT_IMAGE }')); ?>:</label><br /></dt>
		<dd><?php echo (isset($this->_rootref['CONTOUR_AVATAR_IMAGE'])) ? $this->_rootref['CONTOUR_AVATAR_IMAGE'] : ''; ?></dd>
		<dd><label><input type="checkbox" class="radio" name="delete_contour" /> <?php echo ((isset($this->_rootref['L_DELETE_AVATAR'])) ? $this->_rootref['L_DELETE_AVATAR'] : ((isset($user->lang['DELETE_AVATAR'])) ? $user->lang['DELETE_AVATAR'] : '{ DELETE_AVATAR }')); ?></label></dd>
	</dl>
	<dl>
		<dt><label for="uploadfilecontour"><?php echo ((isset($this->_rootref['L_UPLOAD_AVATAR_FILE'])) ? $this->_rootref['L_UPLOAD_AVATAR_FILE'] : ((isset($user->lang['UPLOAD_AVATAR_FILE'])) ? $user->lang['UPLOAD_AVATAR_FILE'] : '{ UPLOAD_AVATAR_FILE }')); ?>:</label></dt>
		<dd><input type="file" id="uploadfilecontour" name="uploadfilecontour" /></dd>
	</dl>
	</fieldset>
